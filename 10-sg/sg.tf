module "mysql_sg"{
    source = "git::https://github.com/Prc1196/terraform-aws-securitygroup.git?ref=main"
...
# JODPS-32 , Bastion host should be accessed from office n/w
...
#RDS server connection through bastion 
...
#backend should accept connection from vpn 1st we are taking SSH access
...
# usally you should configure frontend using private ip from VPN only
